...
console.log(strongPasswordChecker("aaaabbaaabbaaa123456A"))
console.log(strongPasswordChecker("aaa111"))
console.log(strongPasswordChecker("aaaaaaaaaaaaaaaaaaaaa"))
console.log(strongPasswordChecker("10203040aaaaa50607080B"))
console.log(strongPasswordChecker("aaaaaaaAAAAAA6666bbbbaaaaaaABBC"))
